...
Route::get('/admin/delivery/create', 'AdminController@createDelivery');
Route::get('/admin/delivery/{id}/edit', 'AdminController@editDelivery');
Route::post('/delivery/create', 'DeliveryController@store');
Route::post('/delivery/{id}/edit', 'DeliveryController@edit');
Route::get('/delivery/{id}/delete', 'DeliveryController@delete');
