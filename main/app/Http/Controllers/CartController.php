...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('site.cart', compact('sections', 'total', 'cart','options','delivery'));
    }
...
print_R($userCart);
        ...
        $total += Session::get('delivery.delivery_price');
        ...
        $order = Order::create([
            ...
            'delivery_price' => Session::get('delivery.delivery_price'),
            'delivery_method' => Session::get('delivery.delivery_method')
        ]);
    ...
    public function shipping(Request $request)
    {
        ...
        if (!Auth::user()->cart->count()) {
            ...
            Session::put('delivery',[
                'delivery_price' => Delivery::find($request->delivery)->price,
                'delivery_method' => Delivery::find($request->delivery)->name
            ]);
            $user = Auth::user();
