...
<div class="side-sections">
	...
	<ul>
		...
		<li id="products"><a href="{{ url('/admin/products') }}"><i class="fa fa-calendar-o fa-lg"></i>Products</a></li>
		<li id="delivery"><a href="{{ url('/admin/delivery') }}"><i class="fa fa-truck fa-lg"></i>Delivery Methods</a></li>
