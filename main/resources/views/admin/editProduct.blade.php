...
<div class="container-fluid add-product">
	...
	<div class="row">
		<div class="form-group col-md-7">
			...
			<img src="{{ url($product->thumbnail) }}" alt="thumbnail" height="200" width="200">
		...
		<div class="form-group col-md-12">
			...
			<div class="row">
				@foreach($product->photos as $photo)
					<div class="col-md-3">
						<img src="{{ url($photo->photo_src) }}" height="150" width="150">
...
@section('footer')
	<script src="{{ url('js/ckeditor-basic/ckeditor.js') }}"></script>
	<script>
